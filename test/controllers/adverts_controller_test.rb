...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { description: @advert.description, latitude: @advert.latitude, longitude: @advert.longitude, name: @advert.name, picture: @advert.picture, type: @advert.type }
    end
  ...
  test "should update advert" do
    patch :update, id: @advert, advert: { description: @advert.description, latitude: @advert.latitude, longitude: @advert.longitude, name: @advert.name, picture: @advert.picture, type: @advert.type }
    assert_redirected_to advert_path(assigns(:advert))
  end
